  ...
  return (
    ...
    >
      <div className="div relative bg-bgColor w-[100%] h-[100%]">
        <div className="container sm:gap-[0] sm:flex-col h-[200dvh] text-white items-center sm:items-baseline max-w-[480px] sm:max-w-[704px] md:max-w-[1280px] md:gap-[23px] md:px-[15px] flex flex-col relative pt-[54px] sm:mt-[0] sm:pt-[64px] md:pt-[80px] mx-[auto] mb-[0] sm:flex-row">
