  ...
  return (
    ...
    >
      <div className="div relative bg-bgColor w-[100%] h-[100%]">
        <div className="container px-[20px] md:h-[100vh] z-[1] max-w-[480px] sm:block sd:max-w-[440px] sm:max-w-[704px] md:max-w-[1280px] max-w-[280px] text-white md:gap-[281px] md:px-[15px] flex flex-col relative pt-[55px] sm:pt-[64px] md:pt-[80px] sm:mt-[0] mx-[auto] mb-[0] sm:flex-row sm:gap-[48px] sm:pt-[66px]">
