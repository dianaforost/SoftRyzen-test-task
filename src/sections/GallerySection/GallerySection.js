  ...
  return (
    ...
    >
      <div className="div relative bg-bgColor w-[100%] h-[100%]">
        <div className="container px-[20px] z-[1] text-center sm:flex-col text-white max-w-[480px] sm:max-w-[704px] md:max-w-[1280px] md:gap-[0] md:px-[15px] flex flex-col relative pt-[54px] sm:mt-[0] mx-[auto] mb-[0] sm:flex-row sm:gap-[48px] sm:pt-[66px]">
